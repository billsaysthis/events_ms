...
class SpeakersControllerTest < ActionController::TestCase
  ...
  test "should create speaker" do
    assert_difference('Speaker.count') do
      post :create, speaker: { bio: @speaker.bio, name: @speaker.name, photo: @speaker.photo, url: @speaker.url }
    end
  ...
  test "should update speaker" do
    patch :update, id: @speaker, speaker: { bio: @speaker.bio, name: @speaker.name, photo: @speaker.photo, url: @speaker.url }
    assert_redirected_to speaker_path(assigns(:speaker))
  end
